...
if mpi4py is None:
    DDPG, DDPGfED, DDPGfEDLoss, DDPGfMPI, TRPO = None, None, None, None
else:
    from stable_baselines import TRPO  # DDPG, TRPO
    from models import DDPGfED
    from models import DDPGfEDLoss
    from models import DDPGfMPI as DDPG  # Custom DDPG to work with MPI
