...
class TestRightHandMiddleFingerDirectionAccuracy(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        with plt.style.context('ggplot'):
            ...
            fig.suptitle("Right Hand Middle Finger Bone Direction, samples: {}".format(len(cls.right_hand_middle_finger_proximal_direction_x_accuracy)), fontsize=14)

            fig.savefig(os.path.join(test_utils.TEST_DATA_RESULTS_DIRECTORY, "right_hand_middle_finger_direction_accuracy.png"), format="png")
            plt.close()
            ...
            fig.suptitle("Right Hand Middle Finger DH Bone Direction, samples: {}".format(len(cls.right_hand_middle_finger_proximal_dh_direction_x_accuracy)), fontsize=14)

            fig.savefig(os.path.join(test_utils.TEST_DATA_RESULTS_DIRECTORY, "right_hand_middle_finger_dh_direction_accuracy.png"), format="png")
            plt.close()
    ...
    @parameterized.expand([
        ["right_hand_middle_finger_proximal_direction_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
    ...
    @parameterized.expand([
        ["right_hand_middle_finger_proximal_dh_direction_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
        for x in range(test_utils.TEST_NUMBER_DATA_SAMPLES)],
        skip_on_empty=True)
    def test_sequence(self, name, num, accuracy):
        """
    ...
    @parameterized.expand([
        ["right_hand_middle_finger_intermediate_direction_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
        for x in range(test_utils.TEST_NUMBER_DATA_SAMPLES)],
        skip_on_empty=True)
    def test_sequence(self, name, num, accuracy):
        """
    ...
    @parameterized.expand([
        ["right_hand_middle_finger_intermediate_dh_direction_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
        for x in range(test_utils.TEST_NUMBER_DATA_SAMPLES)],
        skip_on_empty=True)
    def test_sequence(self, name, num, accuracy):
        """
    ...
    @parameterized.expand([
        ["right_hand_middle_finger_distal_direction_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
        for x in range(test_utils.TEST_NUMBER_DATA_SAMPLES)],
        skip_on_empty=True)
    def test_sequence(self, name, num, accuracy):
        """
    ...
    @parameterized.expand([
        ["right_hand_middle_finger_distal_dh_direction_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
        for x in range(test_utils.TEST_NUMBER_DATA_SAMPLES)],
        skip_on_empty=True)
    def test_sequence(self, name, num, accuracy):
        """
