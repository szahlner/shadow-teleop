...
class TestRightHandIndexFingerPositionAccuracy(unittest.TestCase):
    ...
    def tearDownClass(cls):
        ...
        with plt.style.context('ggplot'):
            ...
            fig.suptitle("Right Hand Ring Finger Bone End-Position, samples: {}".format(len(cls.right_hand_ring_finger_proximal_position_accuracy)), fontsize=14)

            fig.savefig(os.path.join(test_utils.TEST_DATA_RESULTS_DIRECTORY, "right_hand_ring_finger_position_accuracy.png"), format="png")
            plt.close()
            ...
            fig.suptitle("Right Hand Ring Finger DH Bone End-Position, samples: {}".format(len(cls.right_hand_ring_finger_proximal_dh_position_accuracy)), fontsize=14)

            fig.savefig(os.path.join(test_utils.TEST_DATA_RESULTS_DIRECTORY, "right_hand_ring_finger_dh_position_accuracy.png"), format="png")
            plt.close()
    ...
    @parameterized.expand([
        ["right_hand_ring_finger_proximal_position_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
    ...
    @parameterized.expand([
        ["right_hand_ring_finger_proximal_dh_position_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
        for x in range(test_utils.TEST_NUMBER_DATA_SAMPLES)],
        skip_on_empty=True)
    def test_sequence(self, name, num, accuracy):
        """
    ...
    @parameterized.expand([
        ["right_hand_ring_finger_intermediate_position_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
        for x in range(test_utils.TEST_NUMBER_DATA_SAMPLES)],
        skip_on_empty=True)
    def test_sequence(self, name, num, accuracy):
        """
    ...
    @parameterized.expand([
        ["right_hand_ring_finger_intermediate_dh_position_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
        for x in range(test_utils.TEST_NUMBER_DATA_SAMPLES)],
        skip_on_empty=True)
    def test_sequence(self, name, num, accuracy):
        """
    ...
    @parameterized.expand([
        ["right_hand_ring_finger_distal_position_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
        for x in range(test_utils.TEST_NUMBER_DATA_SAMPLES)],
        skip_on_empty=True)
    def test_sequence(self, name, num, accuracy):
        """
    ...
    @parameterized.expand([
        ["right_hand_ring_finger_distal_dh_position_accuracy_{}".format(x), x, wrapper.args["accuracy"]]
        for x in range(test_utils.TEST_NUMBER_DATA_SAMPLES)],
        skip_on_empty=True)
    def test_sequence(self, name, num, accuracy):
        """
